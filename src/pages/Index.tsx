  ...
  return (
    <div className="min-h-screen bg-background overflow-x-hidden font-sans">
      ...
      <section className="relative bg-gradient-to-br from-background via-secondary/60 to-secondary overflow-hidden">
        <div className="absolute top-0 right-0 w-[500px] h-[500px] bg-accent/5 rounded-full -translate-y-1/3 translate-x-1/3 blur-3xl pointer-events-none hidden md:block" />
        <div className="absolute bottom-0 left-0 w-[400px] h-[400px] bg-primary/5 rounded-full translate-y-1/3 -translate-x-1/3 blur-3xl pointer-events-none hidden md:block" />

        <div className="container mx-auto px-4 py-10 md:py-20 lg:py-32 relative">
          <div className="max-w-3xl mx-auto text-center space-y-5 md:space-y-7">
            <ScrollReveal animation="fade-up" delay={0}>
              <div className="inline-flex items-center gap-2 bg-accent/10 text-accent border border-accent/20 px-3 md:px-4 py-1.5 rounded-full text-xs md:text-sm font-semibold">
            ...
            <ScrollReveal animation="fade-up" delay={80}>
              <h1 className="font-display text-[1.625rem] leading-[1.15] sm:text-3xl md:text-5xl lg:text-6xl font-bold md:leading-[1.1] text-foreground">
            ...
            <ScrollReveal animation="fade-up" delay={240}>
              <div className="flex flex-col sm:flex-row gap-3 justify-center">
                <Link to="/instrutores/marketplace">
                  <Button size="lg" className="w-full sm:w-auto bg-accent hover:bg-accent/90 text-accent-foreground text-sm md:text-base px-6 md:px-8 py-3 shadow-lg hover:shadow-xl transition-all hover:scale-105 group">
                    Encontrar instrutor agora
                    <ArrowRight className="ml-2 w-5 h-5 transition-transform group-hover:translate-x-1" />
                  </Button>
                </Link>
                <Link to="/instrutores/cadastro">
                  <Button variant="outline" size="lg" className="w-full sm:w-auto text-sm md:text-base px-6 md:px-8 py-3 border-primary/30 hover:border-primary transition-all hover:scale-105">
            ...
            <ScrollReveal animation="fade-up" delay={320}>
              <p className="text-xs md:text-sm text-muted-foreground flex flex-wrap items-center justify-center gap-x-4 md:gap-x-5 gap-y-1">
                <span className="flex items-center gap-1.5"><CheckCircle2 className="w-4 h-4 text-success" /> 100% gratuito</span>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 md:gap-8 text-center">
            ...
            <ScrollReveal animation="fade-up" delay={300}>
              <div className="space-y-2">
                <div className="text-2xl md:text-5xl font-bold">24/7</div>
                <div className="text-primary-foreground/80 text-xs md:text-base">Suporte</div>
              </div>
            </ScrollReveal>
          </div>
        </div>
      ...
      {/* ── COMO FUNCIONA — ALUNO ── */}
      <section id="como-funciona" className="py-10 md:py-20 lg:py-28 bg-card">
        <div className="container mx-auto px-4">
          <ScrollReveal animation="fade-up">
            <div className="text-center space-y-2 md:space-y-3 mb-8 md:mb-14">
              <p className="text-accent font-semibold text-xs md:text-sm uppercase tracking-widest">Para o aluno</p>
              <h2 className="font-display text-2xl md:text-[2rem] lg:text-4xl font-bold">Tire sua CNH sem complicação</h2>
            ...
            {ALUNO_STEPS.map((s, i) => (
              <ScrollReveal key={i} animation="fade-up" delay={i * 80}>
                <Card className="group border border-border hover:shadow-lg hover:-translate-y-1 transition-all duration-300 bg-card h-full">
                  <CardContent className="p-5 md:p-6 space-y-3 md:space-y-4 text-center">
                    <div className="w-11 h-11 md:w-12 md:h-12 rounded-xl bg-accent/10 flex items-center justify-center mx-auto group-hover:bg-accent transition-colors duration-300">
                      <s.icon className="w-5 h-5 md:w-6 md:h-6 text-accent group-hover:text-accent-foreground transition-colors duration-300" />
                    </div>
                    <div className="w-7 h-7 md:w-8 md:h-8 rounded-full bg-accent/10 flex items-center justify-center mx-auto font-display font-bold text-accent text-xs md:text-sm">
                      {i + 1}
                    </div>
                    <h3 className="font-display text-sm md:text-base font-bold text-foreground">{s.title}</h3>
      ...
      <section id="instrutores" className="py-10 md:py-20 lg:py-28 section-bg">
        <div className="container mx-auto px-4">
          <ScrollReveal animation="fade-up">
            <div className="text-center space-y-2 md:space-y-3 mb-8 md:mb-14">
              <p className="text-accent font-semibold text-xs md:text-sm uppercase tracking-widest">Para o instrutor</p>
              <h2 className="font-display text-2xl md:text-[2rem] lg:text-4xl font-bold">Receba alunos sem pagar nada antecipado</h2>
              <p className="text-sm md:text-base text-muted-foreground max-w-xl mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6 max-w-5xl mx-auto">
            {INSTRUTOR_STEPS.map((s, i) => (
              <ScrollReveal key={i} animation="fade-up" delay={i * 80}>
                <Card className="group border border-border hover:shadow-lg hover:-translate-y-1 transition-all duration-300 bg-card h-full">
                  <CardContent className="p-5 md:p-6 space-y-3 md:space-y-4 text-center">
                    <div className="w-11 h-11 md:w-12 md:h-12 rounded-xl bg-primary/10 flex items-center justify-center mx-auto group-hover:bg-primary transition-colors duration-300">
                      <s.icon className="w-5 h-5 md:w-6 md:h-6 text-primary group-hover:text-primary-foreground transition-colors duration-300" />
                    </div>
                    <div className="w-7 h-7 md:w-8 md:h-8 rounded-full bg-primary/10 flex items-center justify-center mx-auto font-display font-bold text-primary text-xs md:text-sm">
                      {i + 1}
                    </div>
                    <h3 className="font-display text-sm md:text-base font-bold text-foreground">{s.title}</h3>
                    <p className="text-xs md:text-sm text-muted-foreground leading-relaxed">{s.desc}</p>
      ...
      {/* ── SEGURANÇA ── */}
      <section id="seguranca" className="py-10 md:py-20 lg:py-28 bg-card">
        <div className="container mx-auto px-4">
          <ScrollReveal animation="fade-up">
            <div className="text-center space-y-2 md:space-y-3 mb-8 md:mb-14">
              <p className="text-accent font-semibold text-xs md:text-sm uppercase tracking-widest">Segurança</p>
              <h2 className="font-display text-2xl md:text-[2rem] lg:text-4xl font-bold">Pagamento 100% protegido para os dois lados</h2>
            </div>
          </ScrollReveal>
            ...
            {SECURITY_CARDS.map((c, i) => (
              <ScrollReveal key={i} animation="fade-up" delay={i * 80}>
                <Card className="border border-border hover:shadow-lg hover:-translate-y-1 transition-all duration-300 bg-card h-full">
                  <CardContent className="p-5 md:p-6 space-y-3 md:space-y-4 text-center">
                    <div className={`w-12 h-12 md:w-14 md:h-14 rounded-2xl ${c.color} flex items-center justify-center mx-auto`}>
                      <c.icon className="w-6 h-6 md:w-7 md:h-7" />
                    </div>
                    <h3 className="font-display text-base md:text-lg font-bold text-foreground">{c.title}</h3>
      ...
      {/* ── DEPOIMENTOS ── */}
      <section className="py-10 md:py-20 bg-primary text-primary-foreground relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative">
          <ScrollReveal animation="fade-up">
            <div className="text-center mb-8 md:mb-12">
              <h2 className="font-display text-2xl md:text-[2rem] lg:text-4xl font-bold">O que dizem nossos usuários</h2>
            </div>
          </ScrollReveal>

          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-8 max-w-4xl mx-auto">
            <ScrollReveal animation="scale" delay={0}>
              <div className="bg-white/10 border border-white/20 backdrop-blur-sm rounded-2xl p-5 md:p-8 shadow-xl h-full">
                <div className="flex mb-3 md:mb-5">
                  {[...Array(5)].map((_, i) => (
                    <Star key={i} className="w-4 h-4 md:w-5 md:h-5 text-warning fill-current" />
                  ))}
                </div>
                <blockquote className="text-sm md:text-lg leading-relaxed text-white/90 mb-4 md:mb-6 italic">
                  "Encontrei meu instrutor em 10 minutos e tirei a CNH em 3 meses. Muito mais fácil que ficar ligando pra autoescola."
                </blockquote>
                <div className="flex items-center gap-3">
                  <div className="w-9 h-9 md:w-10 md:h-10 rounded-full bg-white/20 flex items-center justify-center font-display font-bold text-xs md:text-sm">CR</div>
                  <div className="text-left">
                    <p className="font-display font-bold text-xs md:text-sm">Camila R.</p>
                    <p className="text-white/60 text-[11px] md:text-xs">Aluna — São Paulo</p>
                  </div>
                </div>
              </div>
            </ScrollReveal>
            ...
            <ScrollReveal animation="scale" delay={100}>
              <div className="bg-white/10 border border-white/20 backdrop-blur-sm rounded-2xl p-5 md:p-8 shadow-xl h-full">
                ...
                <div className="flex items-center gap-3">
                  <div className="w-9 h-9 md:w-10 md:h-10 rounded-full bg-white/20 flex items-center justify-center font-display font-bold text-xs md:text-sm">CM</div>
                  <div className="text-left">
                    <p className="font-display font-bold text-xs md:text-sm">Carlos M.</p>
                    <p className="text-white/60 text-[11px] md:text-xs">Instrutor credenciado</p>
                  </div>
                </div>
              </div>
            </ScrollReveal>
      ...
      {/* ── CTA INSTRUTOR ── */}
      <section className="py-10 md:py-20 bg-primary/95 text-primary-foreground relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative">
          <ScrollReveal animation="scale">
            <div className="max-w-2xl mx-auto text-center space-y-4 md:space-y-6">
              <h2 className="font-display text-2xl md:text-[2rem] lg:text-4xl font-bold">
              ...
              <Link to="/instrutores/cadastro">
                <Button size="lg" className="w-full sm:w-auto bg-accent hover:bg-accent/90 text-accent-foreground text-sm md:text-base px-6 md:px-10 py-3 shadow-lg hover:shadow-xl transition-all hover:scale-105 group">
      ...
      {/* ── FAQ ── */}
      <section className="py-10 md:py-20 lg:py-28 bg-card">
        <div className="container mx-auto px-4">
          <ScrollReveal animation="fade-up">
            <div className="text-center space-y-2 md:space-y-3 mb-8 md:mb-12">
              <p className="text-accent font-semibold text-xs md:text-sm uppercase tracking-widest">Dúvidas</p>
              <h2 className="font-display text-2xl md:text-[2rem] lg:text-4xl font-bold">Perguntas frequentes</h2>
            </div>
          </ScrollReveal>
      ...
      {/* ── CONTACT ── */}
      <section id="contact" className="py-10 md:py-14 bg-card border-t border-border">
        <div className="container mx-auto px-4">
            ...
            {[
              ...
              <ScrollReveal key={i} animation="fade-up" delay={i * 80}>
                <div className="group space-y-2 md:space-y-3">
                  <div className="w-11 h-11 md:w-12 md:h-12 bg-primary/10 rounded-xl flex items-center justify-center mx-auto group-hover:bg-primary transition-colors duration-300">
                    <Icon className="w-5 h-5 text-primary group-hover:text-primary-foreground transition-colors duration-300" />
                  </div>
                  <p className="font-display font-semibold text-sm">{title}</p>
                  <p className="text-muted-foreground text-xs md:text-sm">{value}</p>
                </div>
              </ScrollReveal>
            ))}
          </div>
